...
func TestAdminAssetsAreEmbeddedAndServed(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/assets/admin.css", contentType: "text/css", markers: []string{".login-shell", ".account-name", ".nav #overviewNav:before", ".log-pre", ".log-block-head", ".log-block.collapsed", ".modal.fullscreen"}},
