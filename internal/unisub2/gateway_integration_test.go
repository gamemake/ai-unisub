...
func TestGatewayModuleUsesVersionTwoProviderHandler(t *testing.T) {
	...
	config, err := json.Marshal(aiprovider2.AccountConfig{
		Kind: aiprovider2.AccountAPI, Name: "test", Supplier: "openai",
		ClientType: aiprovider2.ClientCodex, APIEndpoint: upstream.URL + "/v1",
