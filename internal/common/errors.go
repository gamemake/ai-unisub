...
const (
	...
	// MessageInvalidAIProviderConfig is retained for the legacy application
	// while service2 and unisub2 use the account-oriented name above.
	MessageInvalidAIProviderConfig       = MessageInvalidAccountConfig
	...
	MessageCouldNotGenerateAIProviderID  = "could not generate provider ID"
	MessageCouldNotSaveAIProvider        = "could not save provider"
