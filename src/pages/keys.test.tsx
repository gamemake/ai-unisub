...
it('API Key detail only shows request URL and API key', () => {
  render(<KeyDetails value={{ id: 1, name: 'My Claude', account_id: 2, key: 'sk-test', valid_seconds: 0, created_at: '2026-01-01T00:00:00Z', client_types: ['claude'] }} onClose={() => {}} />)
...
it('API Key detail uses the public root URL for every protocol', () => {
  render(<KeyDetails value={{ id: 2, name: 'Codex', account_id: 3, key: 'sk-codex', valid_seconds: 0, created_at: '2026-01-01T00:00:00Z', client_types: ['codex'] }} onClose={() => {}} />)
